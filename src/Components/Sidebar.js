    ...
    return (
         <div class="col-md-3 col-lg-2 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{backgroundColor:"#e9ecef"}}>
            <ul class="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3 ">
                ...
                <li class="nav-item mb-2"><Link class="nav-link text-secondary" to="/piechart"><i class="far fa-chart-bar font-weight-bold"></i> <span className="ml-3">Graphics</span></Link></li>
